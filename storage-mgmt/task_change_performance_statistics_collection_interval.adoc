...
성능 통계 수집 시간이 정시에 완료하지 못하는 문제는 배너 메시지로 표시됩니다 `Unable to consistently collect from cluster <cluster_name> or Data collection is taking too long on cluster <cluster_name>.`
